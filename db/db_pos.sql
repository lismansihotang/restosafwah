...
insert  into `barang`(`id`,`nm_barang`,`ket_barang`,`harga_beli`,`margin_jual`,`harga_jual`,`id_satuan_kecil`,`id_satuan_besar`,`id_kategori`,`id_lokasi`,`stock`,`min_stock`,`user_id`) values (1,'Sapi Lada Hitam','Sapi Lada Hitam','27000.00','0.00','27000.00',1,3,4,1,0,0,2),(2,'Sapi Kalio Rendang','Sapi Kalio Rendang','27000.00','0.00','27000.00',1,3,4,1,0,0,2),(3,'Sosis Jamur','Sosis Jamur','23000.00','0.00','23000.00',1,3,4,1,0,0,2),(4,'Ayam Jamur','Ayam Jamur','23000.00','0.00','23000.00',1,3,4,1,0,0,2),(5,'Ceker Jamur','Ceker Jamur','23000.00','0.00','23000.00',1,3,4,1,0,0,2),(6,'Ayam Opor','Ayam Opor','23000.00','0.00','23000.00',1,3,4,1,0,0,2),(7,'Oasis 600ml','Oasis 600ml','5000.00','0.00','5000.00',2,3,3,1,0,0,2),(8,'Teh Pucuk Harum','Teh Pucuk Harum','5000.00','0.00','5000.00',2,3,3,1,0,0,2),(9,'Floridina','Floridina','5000.00','0.00','5000.00',2,3,3,1,0,0,2),(10,'Sapi Lada Hitam + Minuman','Sapi Lada Hitam + Minuman','30000.00','0.00','30000.00',1,3,4,1,0,0,2),(11,'Sapi Kalio Rendang + Minuman','Sapi Kalio Rendang + Minuman','30000.00','0.00','30000.00',1,3,4,1,0,0,2),(12,'Sosis Jamur + Minuman','Sosis Jamur + Minuman','26000.00','0.00','26000.00',1,3,4,1,0,0,2),(13,'Ayam Jamur + Minuman','Ayam Jamur + Minuman','26000.00','0.00','26000.00',1,3,4,1,0,0,2),(14,'Ceker Jamur + Minuman','Ceker Jamur + Minuman','26000.00','0.00','26000.00',1,3,4,1,0,0,2),(15,'Ayam Opor + Minuman','Ayam Opor + Minuman','26000.00','0.00','26000.00',1,3,4,1,0,0,2);
...
insert  into `kategori`(`id`,`desc`) values (1,'-'),(2,'Snack'),(3,'Minuman'),(4,'Makanan');
...
insert  into `lokasi`(`id`,`desc`) values (1,'-'),(2,'Rak 1'),(3,'Rak 2');
...
insert  into `meja_pengunjung`(`id`,`nm_meja`,`desc_meja`,`urutan`) values (1,'Meja 1',NULL,1),(2,'Meja 2',NULL,2),(3,'Meja Hijau 1',NULL,3),(4,'Meja Hijau 2',NULL,4),(5,'Meja Family 1',NULL,NULL);
...
insert  into `pelanggan`(`id`,`nm_pelanggan`,`alamat`,`no_telp`,`barcode`,`tgl_bergabung`) values (1,'#CASH','Jl Raya','0855558','','2016-01-01'),(2,'Yudi','Jl Raya Merdeka',NULL,NULL,NULL);
...
insert  into `penjualan`(`id`,`tgl`,`id_pelanggan`,`subtotal`,`disc`,`pajak`,`total`,`pembayaran`,`tipe_bayar`,`user_id`) values (1,'2016-10-30',1,'58000.00','0.00','0.00','58000.00','60000.00','Cash',2),(2,'2016-10-31',1,'35000.00','0.00','0.00','0.00','0.00','Cash',2),(3,'2016-10-31',1,'32000.00','20.00','0.00','31980.00','50000.00','Cash',2),(4,'2016-10-31',1,'5000.00','0.00','0.00','5000.00','10000.00','Cash',3);
...
insert  into `penjualan_detail`(`id`,`id_penjualan`,`id_barang`,`jml`,`harga`,`subtotal`) values (1,1,3,1,'23000.00','23000.00'),(2,1,8,1,'5000.00','5000.00'),(3,1,10,1,'30000.00','30000.00'),(6,2,7,1,'5000.00','5000.00'),(8,2,11,1,'30000.00','30000.00'),(9,3,2,1,'27000.00','27000.00'),(10,3,8,1,'5000.00','5000.00'),(11,4,9,1,'5000.00','5000.00');
...
insert  into `satuan_besar`(`id`,`nm_satuan`,`konversi_satuan`) values (1,'Box',12),(2,'Lusin',12),(3,'-',1);
...
insert  into `satuan_kecil`(`id`,`nm_satuan`) values (1,'-'),(2,'Pcs');
...
insert  into `sys_user`(`id`,`username`,`pass`,`fullname`,`auth_key`) values (2,'admin','21232f297a57a5a743894a0e4a801fc3','Administrator','Mxp-ddb7iVyLy5NBGl3rLyT6MaVP3K6f'),(3,'lisman','c671c2b3e9beeefc84588df82744f55a','Lisman','BTA1R1M8sw3BgPk6mRGklFvcUh5LYcLg');
